...
st.markdown("""
    ...
    /* Columnas de datos dentro de las tarjetas */
...
if st.session_state.seccion == 'menu':
    ...
    if st.button("🚀 CALCULAR"):
        ...
        informe_txt = f"MENSUAL ANTIGUO: {m_ant_real:,.2f} €\n"
    ...
    # (Se mantiene la lógica de atrasos que ya tenías)
